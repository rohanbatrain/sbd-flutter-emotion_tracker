...
class FamilyThemesTab extends ConsumerWidget {
  final String familyId;
  final Function(models.ShopItem) onPurchase;

  const FamilyThemesTab({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final themes = shopState.shopItems
        .where((item) => item.itemType == 'theme')
        .toList();
    ...
    return RefreshIndicator(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildThemeCard(context, theme, item, isOwned);
        },
      ),
    );
  }
